...
/*    */ 
/*    */ public class StrawberryMilkshakeItem extends Item {
/*    */   public StrawberryMilkshakeItem() {
/* 15 */     super((new Item.Properties()).stacksTo(64).rarity(Rarity.COMMON).food((new FoodProperties.Builder()).nutrition(7).saturationModifier(0.7F).alwaysEdible().build()));
/*    */   }
/*    */ 
/*    */   
