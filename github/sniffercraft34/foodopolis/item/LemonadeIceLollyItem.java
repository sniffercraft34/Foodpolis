...
/*    */ 
/*    */ public class LemonadeIceLollyItem extends Item {
/*    */   public LemonadeIceLollyItem() {
/* 15 */     super((new Item.Properties()).stacksTo(64).rarity(Rarity.COMMON).food((new FoodProperties.Builder()).nutrition(6).saturationModifier(0.3F).build()));
/*    */   }
/*    */ 
/*    */   
