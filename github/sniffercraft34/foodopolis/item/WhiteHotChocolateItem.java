...
/*    */ 
/*    */ public class WhiteHotChocolateItem extends Item {
/*    */   public WhiteHotChocolateItem() {
/* 16 */     super((new Item.Properties()).stacksTo(64).rarity(Rarity.COMMON).food((new FoodProperties.Builder()).nutrition(6).saturationModifier(0.4F).alwaysEdible().build()));
/*    */   }
/*    */ 
/*    */   
