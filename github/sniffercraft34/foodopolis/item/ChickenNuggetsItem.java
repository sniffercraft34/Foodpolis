...
/*    */ 
/*    */ public class ChickenNuggetsItem
/*    */   extends Item {
/*    */   public ChickenNuggetsItem() {
/* 16 */     super((new Item.Properties()).stacksTo(64).rarity(Rarity.COMMON).food((new FoodProperties.Builder()).nutrition(7).saturationModifier(0.5F).build()));
/*    */   }
/*    */ 
/*    */   
/*    */   public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
/* 21 */     ItemStack retval = new ItemStack((ItemLike)FoodopolisModItems.BOX.get());
