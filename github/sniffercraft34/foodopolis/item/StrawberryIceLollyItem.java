...
/*    */ 
/*    */ public class StrawberryIceLollyItem extends Item {
/*    */   public StrawberryIceLollyItem() {
/* 15 */     super((new Item.Properties()).stacksTo(64).rarity(Rarity.COMMON).food((new FoodProperties.Builder()).nutrition(6).saturationModifier(0.5F).build()));
/*    */   }
/*    */ 
/*    */   
