...
/*    */ 
/*    */ public class LemonCurdItem
/*    */   extends Item {
/*    */   public LemonCurdItem() {
/* 16 */     super((new Item.Properties()).stacksTo(64).rarity(Rarity.COMMON).food((new FoodProperties.Builder()).nutrition(6).saturationModifier(0.5F).alwaysEdible().build()));
/*    */   }
/*    */ 
/*    */   
